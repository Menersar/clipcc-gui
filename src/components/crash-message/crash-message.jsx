...
const CrashMessage = props => (
    <div className={styles.crashWrapper}>
        <Box className={styles.body}>
            ...
            <p>
                <FormattedMessage
                    defaultMessage={'We are so sorry, but it looks like Sidekick has crashed. This bug has been' +
                        ' automatically reported to the Sidekick Team. Please refresh your page to try' +
                        ' again.'}
