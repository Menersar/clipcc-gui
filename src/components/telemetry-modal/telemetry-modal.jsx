...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve Sidekick',
        description: 'Sidekick telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The Sidekick Team is always looking to better understand how Sidekick is used around the ' +
            'world. To help support this effort, you can allow Sidekick to automatically send usage information to ' +
            'the Sidekick Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the Sidekick privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the Sidekick Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the Sidekick Team',
        description: 'Text for telemetry modal opt-in button',
